	...
	def mutate(self, individual_city, rate):
		...
		if rate > 0.9:
			if mutation_pick > 0.5:
					...
					#Victoria's thing. Switches 1 random element with neighbour. 
					print(individual_city, "!!!!!!!!!!!!!!!!!!!!")
					print(len(individual_city))
					exchanged = random.randint(0, len(individual_city)-2)
					print(exchanged)
					exchanged_with = exchanged + 1
	...
	def pass_time(self, population, generations):
		...
		for i in range(len(optimal_routes)):
				...
				if i >= 1: 
					indx1 = i
					indx2 = i - 1
					diff = optimal_dists[indx1] - optimal_dists[indx2]
					
					if diff < np.std(optimal_dists):
						if optimal_dists[indx1] < optimal_dists[indx2]:
							print("index: ",indx1)
							print(optimal_routes[indx1], 'OPTIMAL ROUTE')
							print(optimal_dists[indx1], "OPTIMAL DIST")
							optimal_route_index = indx1
						elif optimal_dists[indx2] < optimal_dists[indx1]:
							print("index: ",indx2)
							print(optimal_routes[indx2], 'OPTIMAL ROUTE')
							print(optimal_dists[indx2], "OPTIMAL DIST")
							optimal_route_index = indx2
						elif optimal_dists[indx2] == optimal_dists[indx1]:
							print("index: ",indx1)
							print(optimal_routes[indx1], 'OPTIMAL ROUTE')
							print(optimal_dists[indx1], "OPTIMAL DIST")
